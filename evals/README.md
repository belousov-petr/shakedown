...
Test cases for measuring whether `deep-project-audit` adds value over a bare "audit this project" prompt. Follows the [agentskills.io eval methodology](https://agentskills.io/skill-creation/evaluating-skills).
...
```
deep-project-audit-workspace/
  iteration-1/
    eval-small-cli-tool/
      with_skill/
        outputs/           # Audit report output
