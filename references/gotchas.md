# Audit Gotchas — Reference

Common mistakes agents make during project audits. These are not generic
advice — each one is a failure mode observed in real audit outputs. Read
...
**The mistake:** Auditing functionality, security, and architecture
...
**The fix:** Every audit should estimate operational cost:
...
**The mistake:** If the user says "audit the backend," only looking
...
components. A backend audit that misses the deployment pipeline
